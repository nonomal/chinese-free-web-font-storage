    ...
    return (<>
        <div>
            <label>
                ...
                ></input>{$t("1f9a08ca1499a450a35c48d669498104")}</label>
        </div>
        <table>
            <thead>
                <tr>
                    ...
                    >{$t("f121a7f53dd45bf3d2ddc64f2dfea381")}</th>
                    ...
                    >{$t("e16f8c41b6c11feaefcb20d8a711ce7f")}</th>
                    <th
                        onclick={() => {
                            setData(() =>
                                props.data.sort((a, b) => {
                    ...
                    >{$t("caf8b0b2cc1952bf60cbae20dbdef221")}</th>
