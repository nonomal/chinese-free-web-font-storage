...
export const LanguageSwitcher = (props: { location: string }) => {
    const location = isServer ? new URL(props.location) : window.location;
    ...
    return (
        <div class="flex items-center">
            ...
            <select onchange={changeLanguage} class='outline-none'>
                {config.map((i) => {
                    return (
                        <option
                            selected={lang === i.value}
                            value={
                                '/' +
                                i.value +
                                '/' +
